...
float SurfaceManager::GetHeightAtPosition(float x, float z)
{
...
float SurfaceManager::CalculateCurvedHeight(float x, float z)
{
...
Vector3 SurfaceManager::GetSurfaceNormalAtPosition(float x, float z)
{
...
void SurfaceManager::GenerateGroundSurface()
{
...
void SurfaceManager::DrawGround()
{
    if (WIRE_FLOOR)
    {
...
void SurfaceManager::UnloadGround()
{
    UnloadModel(model);
